...
const LoginPage = () => {
	...
	return (
		<div className='flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0'>
			<div className='w-full bg-glass rounded-lg bg-gray-500/10 border-gray-400 shadow-xl  md:mt-0 sm:max-w-md xl:p-0'>
				<div className='p-6 space-y-4 md:space-y-6 sm:p-8'>
					<h1 className='text-xl font-bold  md:text-2xl text-center text-gray-600'>Login to your account</h1>
					<button
						type='button'
